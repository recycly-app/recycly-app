<template>
  <div class="column items-center deposer-annonce">
    <h5 class="no-margin">Déposer une annonce sur Recycly</h5>
    <FormAnnonce v-if="store.isLogged" />
    <DeposerNotLogged v-else />
  </div>
</template>
